    ...
    return (
        <Container className="about-page">
            ...
            <Row className="text-center mt-5 mb-5">
                <Col>
                    <h1>Về Chúng Tôi</h1>
                    <p className="lead">Khám phá sứ mệnh và giá trị cốt lõi của Ecorganic</p>
                </Col>
            </Row>
            ...
            <Row className="mb-5">
                <Col md={6}>
                    <Image src="/path/to/image.jpg" fluid rounded /> {/* Thay đổi src thành đường dẫn hình ảnh của bạn */}
                </Col>
                <Col md={6}>
            ...
            {/* Phần Triết Lý */}
            <Row className="philosophy-section mb-5 p-5 bg-light rounded">
                <Col>
